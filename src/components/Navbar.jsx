...
function Navbar({ showMobileSidebar, toggleMobileSidebar }) {
  const panelStyles = showMobileSidebar
    ? 'translate-x-[0] shadow-two'
    : 'translate-x-[-100%]';
  ...
  return (
    ...
    >
      ...
      <div className="flex-1">
        {/* button */}
        <div className="bg-[#45269C] px-[1.2rem] sm:px-[2.5rem] py-[1.2rem]  text-[1.6rem] leading-[1.9rem] rounded-[8px] flex items-center justify-center gap-[1.144rem] ">
          <Lightning />
          Welcome Keerthi
        </div>
        {/* menu items */}
